...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'ability:role:admin'])->group(function () {
        ...
        Route::post('knowledge-bases/{id}/remove', [KnowledgeBaseController::class, 'destroy']);

        // Admin Moderation - delete community posts
        Route::delete('admin/communities/{id}', [CommunityController::class, 'destroy']);
        Route::post('admin/communities/{id}/remove', [CommunityController::class, 'destroy']);
        ...
        Route::post('academic-modules/{id}/remove', [AcademicModuleController::class, 'destroy']);
    ...
    Route::middleware(['auth:sanctum', 'ability:role:student'])->group(function () {
        ...
        Route::post('/chat/history/clear',  [ChatController::class, 'clearHistory']);
